...
var m__5219__auto__ = (hickory.core.as_hiccup[goog.typeOf(x__5218__auto__)]);
if(!((m__5219__auto__ == null))){
return m__5219__auto__.call(null,this$);
} else {
var m__5219__auto____$1 = (hickory.core.as_hiccup["_"]);
...
var x__5218__auto__ = (((this$ == null))?null:this$);
var m__5219__auto__ = (hickory.core.as_hickory[goog.typeOf(x__5218__auto__)]);
if(!((m__5219__auto__ == null))){
return m__5219__auto__.call(null,this$);
} else {
var m__5219__auto____$1 = (hickory.core.as_hickory["_"]);
if(!((m__5219__auto____$1 == null))){
return m__5219__auto____$1.call(null,this$);
} else {
...
var pred__10991 = cljs.core._EQ_;
var expr__10992 = (this$["nodeType"]);
if(cljs.core.truth_(pred__10991.call(null,hickory.core.Attribute,expr__10992))){
...
var pred__10994 = cljs.core._EQ_;
var expr__10995 = (this$["nodeType"]);
if(cljs.core.truth_(pred__10994.call(null,hickory.core.Attribute,expr__10995))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword.call(null,(this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_(pred__10994.call(null,hickory.core.Comment,expr__10995))){
...
if(cljs.core.truth_(pred__10994.call(null,hickory.core.Document,expr__10995))){
...
if(cljs.core.truth_(pred__10994.call(null,hickory.core.DocumentType,expr__10995))){
...
if(cljs.core.truth_(pred__10994.call(null,hickory.core.Element,expr__10995))){
...
if(cljs.core.truth_(pred__10994.call(null,hickory.core.Text,expr__10995))){
return (this$["wholeText"]);
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__10995)].join('')));
}
}
}
}
...
var temp__4425__auto__ = cljs.core.second.call(null,(function (){var or__4563__auto__ = cljs.core.re_find.call(null,/<!DOCTYPE ([^>]*)>/,s);
...
var doctype = temp__4425__auto__;
...
var temp__4425__auto___10997 = cljs.core.first.call(null,(doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__4425__auto___10997)){
var title_el_10998 = temp__4425__auto___10997;
if(cljs.core.empty_QMARK_.call(null,(title_el_10998["text"]))){
hickory.core.remove_el.call(null,title_el_10998);
} else {
}
} else {
}
...
var or__4563__auto__ = hickory.core.parse_dom_with_domparser.call(null,s);
if(cljs.core.truth_(or__4563__auto__)){
return or__4563__auto__;
} else {
